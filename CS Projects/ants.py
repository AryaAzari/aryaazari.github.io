...
# The WallAnt class
class WallAnt(Ant):
    """WallAnt is an ant that does nothing each turn but has a large health value."""
...
# The HungryAnt Class
class HungryAnt(Ant):
    """HungryAnt selects a random Bee from its Place and eats it whole."""
...
class ProtectorAnt(ContainerAnt):
    ...
    def __init__(self, health=2):
        """Create a ProtectorAnt with a HEALTH quantity."""
        super().__init__(health)
    # END Problem 8c

# BEGIN Problem 9
class TankAnt(ContainerAnt):
    """TankAnt provides protection to other Ants and deals damage to Bees."""
...
class ScubaThrower(ThrowerAnt):
    ...
    def __init__(self, health=1):
        """Create a ScubaThrower with health."""
        super().__init__(health)
    ...
    def action(self, gamestate):
        ...
        while current_place:
            ...
            if ant:
                ...
                if ant.is_container and ant.ant_contained and ant.ant_contained not in self.doubled_ants:
